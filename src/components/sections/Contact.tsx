        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`p-3 bg-gray-100 text-gray-600 rounded-lg ${social.color} transition-all duration-200 border border-gray-200`}
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-gray-100 to-accent-50 rounded-xl p-6 border border-gray-200"
            >
              <h4 className="text-lg font-semibold text-gray-900 mb-2">Availability</h4>
              <div className="flex items-center space-x-2 mb-3">
                <div className="w-3 h-3 bg-accent-600 rounded-full animate-pulse" />
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-primary-700 text-white py-3 px-6 rounded-lg font-medium hover:bg-primary-800 focus:ring-2 focus:ring-primary-600 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center space-x-2"
              >
                {formStatus === 'sending' && (
                  <>
              ...
              {formStatus === 'success' && (
                <motion.div
                  ...
                  className="text-center text-accent-700 bg-accent-50 p-3 rounded-lg"
                >
              ...
              {formStatus === 'error' && (
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="text-center text-red-700 bg-red-50 p-3 rounded-lg"
                >
